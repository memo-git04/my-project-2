...
if (isset($_POST['btn_update_order'])) {
    ...
    if ($status == 3 && $currentStatus == 4) {
        $_SESSION['err_update_status'] = "Don't update status for order!";
        header("location: index.php?page_layout=order.php");
    } else {
        $sqlUpdateStatus = "UPDATE orders SET status_id = $status WHERE order_id = $order_id";
    ...
    <div class="col-md-12">
        <form action="" method="post">
            <select name="order_status" id="">
                ...
                <option value="2" <?php
                                    if ($resultOrder['status_id'] == 2) {
                                        echo "selected";
                                    }
                                    if ($resultOrder['status_id'] == 4) {
                                        echo "disabled";
                                    }
                                    if ($resultOrder['status_id'] == 5) {
                                        echo "disabled";
                                    }
                                    if ($resultOrder['status_id'] == 3) {
                                        echo "disabled";
                                    }
                                    ?>>Confirmed</option>
                <option value="3" <?php
